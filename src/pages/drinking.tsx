  ...
  return (
    <div className="flex flex-col relative h-full">
      ...
      <div className="absolute bottom-[44px]">
        <Description text={`외국어, 외래어를 사용하지 않는\n게임이에요.\n시작 버튼을 누르면 제가 타이머를 셀께요!`}/>
        <img
        ...
        <div className="flex flex-row space-x-[11px] w-full px-4 ">
          <LargeButton text="다른게임" bgColor="bg-background_elevated" textColor="text-black" onClick={() => {}} />
          <LargeButton text="시작하기" bgColor="bg-main_primary" textColor="text-black" onClick={() => {}} />
        </div>
      </div>
